			...
			<div className="max-w-[540px] md:max-w-[720px] lg:max-w-[1300px] px-4 w-full mx-auto flex flex-col justify-center">
				{/* <div className="space-x-4 text-right mb-2">
					<a
						...
						className="text-[#d40035] hover:text-white transition-colors delay-300 ease-in-out text-lg leading-5"
					>
						Home
					</a>
					<span className="text-[#d40035]">/</span>
					<span className="text-[#d40035] text-lg leading-5">
						{breadcrumbLink}
					</span>
				</div> */}
				<div className="text-right">
					<p className="md:text-7xl text-5xl font-medium">
						{title}
						{/* Cost <span className="text-[#d40035]">Estimator</span> */}
					</p>
				</div>
			</div>
		</div>
